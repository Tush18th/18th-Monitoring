...
class ValidationEngine {
    static rules = [
        ...
        // --- Business Rule Validation ---
        {
            ...
            validate: (p) => {
                ...
                if (amt === undefined)
                    return { isValid: true }; // Skips if field missing
                return {
        ...
        // --- Order Financial Correctness (Requirement 7) ---
        {
            ...
            severity: 'HIGH',
            validate: (p) => {
                if (p.eventType !== 'order_placed' && p.eventType !== 'POLL_SYNC')
                    return { isValid: true };
     ...
     */
    static async revalidate(eventId, payload) {
